	...
	ServerSocket ss=new ServerSocket(3333);
     ...
     boolean sss;
		...
		server2()throws Exception
		{
			...
			JLabel jLabel7=new JLabel(new ImageIcon("server2.jpg"));
			v1=new Vector();
			setResizable(false);
	        allsta="allow";
			jLabel1 = new JLabel(); 
			...
			op1.write(rew.getBytes());
	 		...
	 		addComponent(contentPane, jLabel1, 370,114,173,18); 
	 		addComponent(contentPane, jLabel2, 24,114,210,18); 
	 		//addComponent(contentPane, jLabel3, 9,44,99,38); 
	 		addComponent(contentPane, jLabel4, 121,78,392,35); 
 			addComponent(contentPane, jScrollPane1, 377,135,151,209); 
 			addComponent(contentPane, jScrollPane2, 12,136,350,373); 
	 		addComponent(contentPane, jButton1, 377,360,151,28); 
 			addComponent(contentPane, jButton5, 377,395,151,28); 
			addComponent(contentPane, jButton2, 377,430,151,28);
 			addComponent(contentPane, jButton3, 377,465,151,28); 
	 		addComponent(contentPane, jButton6, 377,500,151,28);
			*/
			...
			addComponent(contentPane, jLabel7, 10,0,470,120); 
				...
				jButton2.setEnabled(false);
				jButton5.setEnabled(false);
				this.setTitle("Server Cluster 2 is Running ..."); 
...
public void msg()
	{
		...
		try
		{
					...
					while(true)
					{
							...
							jLabel1.setText("Receiving Req From Server : "+resu);
							Thread.sleep(2000);
							...
							else
							{
								...
								input.read(b);
								oos.writeObject(b);
								System.out.println(" send to server : "+b);
